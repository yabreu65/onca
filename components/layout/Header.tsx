...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="bg-[#1D1D1B] text-white py-4 md:block">
        <div className="text-xs md:text-xl font-roboto  px-4 flex justify-center gap-12 md:gap-32">
          <a
            ...
            className="flex items-center gap-2 hover:text-onca-orange transition-colors"
          >
            <Phone size={0} />
            {siteConfig.phone}
          </a>
      ...
      <header
        className={cn(
          "sticky max-[400px]:px-0 px-6  top-0 z-50 transition-all duration-300",
      ...
      >
        ...
        <div className=" xl:max-w-full  py-0 md:py-6 relative">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex lg:pr-6 font-roboto lg:text-lg xl:text-xl items-center relative z-10">
              <Link
