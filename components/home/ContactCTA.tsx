  ...
  return (
    <section id="contacto-cta" className="py-24 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a1628 0%, #1a365d 50%, #0a1628 100%)' }}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <div className="flex justify-center mb-12"><Logo variant="white" size="lg" /></div>
        <h2 className="text-4xl md:text-5xl font-montserrat font-black text-white mb-6">{t('title')}</h2>
        <p className="text-blue-200 text-lg mb-10">{t('subtitle')}</p>
        <a href={`https://wa.me/${siteConfig.whatsapp}`} target="_blank" rel="noopener noreferrer" onClick={() => trackEvents.whatsappClick()} className="btn-whatsapp text-xl">
